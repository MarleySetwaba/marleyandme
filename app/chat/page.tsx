          ...
          <div className="mt-16 space-y-5">
{
  ...
  {message.role === 'user' ? (<UserMessage message={message.display}/>) : (<>{message.display}</>)}
    ...
    <div className="relative py-2">
      ...
      <button type="button" className="mx-4 my-auto inline-flex flex-shrink-0 justify-center items-center size-8 rounded-lg text-davys_gray-900 bg-blue-600 hover:bg-blue-500 focus:z-10 focus:outline-none focus:ring-2 focus:ring-blue-500"       
      onClick={async () => {
